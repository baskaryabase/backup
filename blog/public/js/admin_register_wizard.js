...
var flag='';
  ...
  var register_full=$('#register_full').val();
var phoneno = /^\d{10}$/;
...
if(register_email == ''){
  $('#register_email').after('<span class="wpcf7-not-valid-tip">This field is required</span>');  
}
if(register_full == ''){
  $('#register_full').after('<span class="wpcf7-not-valid-tip">This field is required</span>');  
}
...
if(register_full == '' || register_email == '' || register_phone == '' || register_location == '' || register_aoe == null || personal_domain == null || register_profile == ''){  

                    ...
                    <div class="box-footer box-comments" style="display: block;">
                      ...
                      <div class="box-comment">
                        ...
                        <div class="comment-text">
                          ...
                          <a><br><div class=" icon-remove-sign"  data-post="{{ $cvalue['comment_id'] }}" data-parent="<?php echo $details['post_id'] ?>" onclick="delete_comment(this)"  style="font-size: 10px;cursor: pointer" >Delete</div> </a>

...
<div class="row" >
 ...
 <label class="col-md-5" style="margin: 2% 0% 1% 0%">
      ...
      <div class="pio" style="border:2px solid green;background-color: white">
       ...
       <div style="margin-top: 5px;background-color:green;padding:2%;font-size: 20px;color:white; text-align: center"><i style="font-size:25px" class="fa fa-inr" aria-hidden="true"> <b> 4000 </b></i></div>

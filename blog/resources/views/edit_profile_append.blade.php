...
if(!empty($cvalue)){
                    ...
                    <div class="box-footer" style="display: block;">
                        ...
                        <img class="img-responsive img-circle img-sm" src="<?php echo session()->get('profile_pic'); ?>" alt="Alt Text">
                         ...
                         <textarea rows="1" data-post="{{ $value['post']['post_id'] }}" class="comment_field" onkeypress="comment_post(event,this)" placeholder="Enter your comment"></textarea>

                       <button type="button" data-member="{{ $value['post']['post_author'] }}" data-post="{{ $value['post']['post_id'] }}" onclick="comment_post_enter(this)"  class="btn btn-default btn-xs sendbtn">  send </button>

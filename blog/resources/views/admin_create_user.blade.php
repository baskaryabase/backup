...
<link href="<?php echo URL::asset('/css/admin_register_custom.css') ?>" rel="stylesheet" type="text/css">
...
<input type="text" name="register_email" class="form-control" id="register_email" value=""  placeholder="Email" />
</div>

<div class="width-70pc" >
<input type="text" class="form-control" name="register_full" id="register_full" value=""  placeholder="Full name" />
</div>
...
<input type="hidden"  id="hidden_role" name="hidden_role" value="">
...
<span class="register_profile_error file-input btn btn-block btn-default btn-file width-25pc margin-tp-sm">
                              Profile Picture <input type="file" id="register_profile" >
                          </span>
...
<input type="button" name="submit" class="submit third action-button" value="Submit" />
    ...
    <script src="<?php echo URL::asset('/js/admin_register_wizard.js') ?>"></script>
...
var selected = false;
      ...
      $('#register_location').on('focus', function() {
  selected = false;
  }).on('blur', function() {
    if (!selected) {
      $(this).val('');

...
<head>
	...
	<link href="<?php echo URL::asset('/css/owl.carousel.css') ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo URL::asset('/css/owl.theme.default.min.css') ?>" rel="stylesheet" type="text/css">
